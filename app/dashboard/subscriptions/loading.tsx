    ...
    <div className="space-y-8 animate-pulse">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="mt-1.5 h-3 w-32 rounded bg-cream-3" />
        </div>
      ...
      <div className="rounded-2xl border border-cream-3 bg-white p-6">
        <div className="h-5 w-40 rounded-lg bg-cream-3 mb-5" />
        <div className="h-6 w-full rounded-full bg-cream-3" />
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="rounded-xl border-2 border-cream-3 p-4">
